...
bird_up = pygame.image.load("images/yellowbird-upflap.png")
bird_down = pygame.image.load("images/yellowbird-downflap.png")
bird_mid = pygame.image.load("images/yellowbird-midflap.png")
...
# Loading pipe image
pipe_img = pygame.image.load("images/greenpipe.png")
...
game_over = False
over_img = pygame.image.load("images/img_45.png").convert_alpha ()
...
high_score = 0
score_time = True
score_font = pygame.font.Font("images/04B_19.TTF", 27)
